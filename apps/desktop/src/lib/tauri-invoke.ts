...
interface TauriCommands {
  ...
  docker_list_images: {
    args: Record<string, never>;
    ret: Array<{ id: string; repository: string; tag: string; size: string; created: string }>;
  };
...
export function tauriInvokeRaw<T>(command: string, args?: Record<string, unknown>): Promise<T> {
