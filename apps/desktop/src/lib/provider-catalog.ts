...
export const PROVIDERS: ProviderInfo[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'glm-5.2', name: 'GLM 5.2 (Zen)', supportsThinking: false, thinkingType: 'none' },
  ...
  },
  {
    ...
    needsKey: true,
    models: [
      { id: 'glm-5.2', name: 'GLM 5.2 (Go)', supportsThinking: false, thinkingType: 'none' },
      {
        id: 'kimi-k2.7-code',
      ...
      { id: 'minimax-m3', name: 'MiniMax M3 (Go)', supportsThinking: false, thinkingType: 'none' },
      {
        id: 'qwen3.7-max',
        name: 'Qwen3.7 Max (Go)',
        supportsThinking: true,
      ...
      },
      {
        ...
        supportsThinking: true,
        thinkingType: 'openai',
        thinkingLevels: ['low', 'medium', 'high', 'max', 'xhigh'],
      },
      {
