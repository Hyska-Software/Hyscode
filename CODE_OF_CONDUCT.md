...
- Trolling, comentários insultuosos ou ataques políticos
- Assédio público ou privado
- Publicar informações privadas de outros, como endereço físico ou eletrônico, sem consentimento explícito
- Outra conduta que poderia razoavelmente ser considerada inadequada em um ambiente profissional

## Aplicação

Instâncias de comportamento abusivo, de assédio ou inaceitável podem ser relatadas entrando em contato com a equipe do projeto em `conduct@hyscode.dev`. Todos os relatórios serão revisados e investigados promptamente.

Todos os membros da comunidade são obrigados a respeitar este Código de Conduta. Violações podem resultar em remoção da comunidade, repositório ou projeto conforme determinado pela equipe de manutenção.
