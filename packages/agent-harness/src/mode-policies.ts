...
const MODEL_PROFILES: ModelProfile[] = [
  {
    pattern: 'claude-sonnet-5|claude-sonnet-4-6',
  ...
  {
    pattern: 'claude-3-5-haiku|claude-3.5-haiku',
    maxContext: 200_000,
    recommendedMaxOutput: 64_000,
    supportsToolCalling: true,
    supportsThinking: false,
  ...
  {
    pattern: 'claude-fable-5|claude-opus-5|claude-opus-4-8|claude-opus-4-7|claude-opus-4-6',
    maxContext: 1_000_000,
    recommendedMaxOutput: 128_000,
    supportsToolCalling: true,
    supportsThinking: true,
  ...
  {
    pattern: 'claude-opus-4-5|claude-opus-4$',
    maxContext: 200_000,
  ...
  {
    pattern: 'gpt-5\\.3|gpt-5\\.2|gpt-5\\.1|gpt-5$|gpt-5-codex|gpt-5-nano|gpt-5\\.3-codex',
    maxContext: 272_000,
    recommendedMaxOutput: 128_000,
    supportsToolCalling: true,
    supportsThinking: true,
  ...
  {
    pattern: 'gemini-3\\.[1-9]|gemini-3-flash|gemini-3\\.5-flash-lite',
    maxContext: 1_000_000,
  ...
  {
    pattern: 'kimi-k2\\.7-code|kimi-k2\\.6',
    maxContext: 262_144,
  ...
  {
    pattern: 'minimax-m3|minimax-m2\\.7|minimax-m2\\.5',
    maxContext: 1_000_000,
    recommendedMaxOutput: 16_384,
    supportsToolCalling: true,
    supportsThinking: true,
  ...
  {
    pattern: 'deepseek-v4-pro|deepseek-v4-flash|deepseek-v4-flash-free',
    maxContext: 1_000_000,
  ...
  {
    pattern: 'hy3|laguna-s-2\\.1-free|ling-3\\.0-flash-free',
    maxContext: 1_000_000,
    recommendedMaxOutput: 16_384,
    supportsToolCalling: true,
    supportsThinking: true,
  ...
  {
    pattern: 'big-pickle|north-mini-code-free|nemotron-3-ultra-free',
    maxContext: 128_000,
    recommendedMaxOutput: 8_192,
    supportsToolCalling: true,
    supportsThinking: false,
