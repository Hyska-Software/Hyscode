...
const MODEL_PROFILES: ModelProfile[] = [
  ...
  {
    pattern: 'gpt-5\\.3|gpt-5\\.2|gpt-5\\.1|gpt-5$|gpt-5-codex|gpt-5-nano',
    maxContext: 272_000,
    recommendedMaxOutput: 128_000,
    supportsToolCalling: true,
    supportsThinking: true,
  ...
  {
    pattern: 'deepseek-r1|deepseek/deepseek-r1',
    maxContext: 128_000,
  ...
  {
    pattern: 'deepseek-v4-pro|deepseek-v4-flash-free',
    maxContext: 128_000,
    recommendedMaxOutput: 8_192,
    supportsToolCalling: true,
    supportsThinking: true,
